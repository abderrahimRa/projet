...
@Component({
  ...
  templateUrl: './pcd23.component.html',
  styleUrls: ['./pcd23.component.css'],
  standalone: false,
})

export class Pcd23Component {
    isTableHidden = false;
